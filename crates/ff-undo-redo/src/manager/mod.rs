...
pub struct DocumentUndoManager {
    pub(super) config: UndoConfig,
    pub(super) undo_stack: UndoStack,
    pub(super) redo_stack: RedoStack,
    pub(super) scrap: ScrapStack,
    pub(super) save_point: SavePointState,
    pub(super) coalesce: CoalesceState,
    pub(super) tentative: TentativeState,
    pub(super) builder: TransactionBuilder,
    pub(super) current_selection: Option<SelectionState>,
    pub(super) listeners: Vec<(ListenerId, Box<dyn UndoNotifier>)>,
