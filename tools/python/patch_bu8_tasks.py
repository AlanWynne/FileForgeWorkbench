...
old = b"- [ ] BU.8 AllocatedDataset struct, datasets HashMap, and TOML persistence removed (Task 26)"
new = b"- [x] BU.8 AllocatedDataset struct, datasets HashMap, and TOML persistence removed (Task 26)"
