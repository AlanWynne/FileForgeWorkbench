...
| 3 | logging-subsystem | 0 | DONE | units/logging-subsystem.md | FUNCTIONALLY COMPLETE; Req 12 tool done but tracking stale (PA-TRACK-002); CR-NR-058 ADDED Req 13 build-profile gate -- UNIMPLEMENTED (PA-CR058, key dev/debug-logging enabler); PA-LOG-002 audit data; refactor PA-STD-003 |
