...
## Phase dispatch-classifier (CR-CH-044) -- typed path through the Target_Resolution classifier

Behaviour-preserving; TDD (failing tests first). Reuses the EXISTING
