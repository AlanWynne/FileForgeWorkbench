...
- **Status**: PENDING GATE
- **Linked spec**: `docs/specs/menu-workspace/requirements.md` (new Requirement 14; reconciles Req 5); `docs/specs/startup-and-session/requirements.md` (START + END/close, Req 14); `docs/specs/menu-workspace/cw-requirements.md` Req 10.4
