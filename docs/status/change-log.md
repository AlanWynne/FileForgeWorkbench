...
- **Status**: GATE DONE (menu-workspace Req 1.8 + Req 2.1a-2.1c revised/added, design delta, tasks 22.x, TCR rows authored); IMPLEMENTATION next (fold primary_option_menu layout into the shared renderer; render POM via it). Addresses the owner's "Settings should look like the POM" reports.
