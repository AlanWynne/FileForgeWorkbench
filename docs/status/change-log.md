...
- **Status**: IN PROGRESS -- Phase DB gate APPROVED (spec DB.3-DB.5 written: command-configurator sub-project + shell-command Req 19). Implementation (DB.9, DB.10) pending a separate instruction.
