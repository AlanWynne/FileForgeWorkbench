...
- **Status**: PENDING GATE
- **Linked spec**: `docs/specs/menu-workspace/requirements.md` Req 4 (+ Req 2.4), `docs/specs/menu-workspace/cw-requirements.md` Req 11; `docs/specs/configuration-system/requirements.md` (RESET BARE / archive); `docs/specs/startup-and-session/requirements.md` (recovery baseline on corrupt/missing)
