...
- **Status**: PENDING GATE
- **Linked spec**: `docs/specs/menu-workspace/requirements.md` (new Requirement 13); closes `docs/specs/menu-workspace/tasks.md` task 23.9 (configuration-system Req 19.7)
